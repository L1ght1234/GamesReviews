...
const MyReviewsPage: React.FC = () => {
  ...
  }, [currentPage, filter.sortBy, filter.sortDirection, filter.tag, filter.search, isAuthenticated]);
      ...
      <Layout>
        <div className="max-w-2xl mx-auto">
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p>Для просмотра своих обзоров необходимо войти в аккаунт.</p>
          </div>
        </div>
      </Layout>
    );
    ...
    <Layout>
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">Мои обзоры</h1>
        ...
        <SearchAndFilter
          ...
          placeholder="Поиск в моих обзорах..."
        />
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground text-lg mb-4">У вас еще нет обзоров</p>
